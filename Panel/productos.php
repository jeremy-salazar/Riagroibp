        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <div class="container text-center">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="./Productos/insertarPro.php"><button id="btnNuevo" type="button" class="btn btn-success">Nuevo</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <div class="btn-group">
                                                        <a href="./Productos/editarPro.php?id=<?php echo $row['id_producto']?>"><input class="btn btn-warning" type="submit" value="Editar"></a>                                                                             
                                                        <form action="./Productos/elimina.php" method="post">
                                                        <input type="hidden" value="<?php echo $row['id_producto']?>" name="txtID"readonly>
                    ...
                    <div class="container-fluid px-4">
                    <a href="./Productos/excel.php"><button id="btnNuevo" type="button" class="btn btn-success"><img src="../Images/table.svg" alt=""> EXCEL</button></a>
