    ...
    <div class="container">
			...
			<form class="form-horizontal" method="POST" action="modificar.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="descuento" class="form-control" value="<?php echo $row['descuento'];?>" id="descuento" name="descuento" placeholder="descuento">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" value="<?php echo $row['estado'];?>" id="estado" name="estado" placeholder="estado">
