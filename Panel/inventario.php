                ...
                <div class="modal-content">
                    ...
                    <form id="formCrud">    
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="datos" class="col-form-label">Nombre:</label>
                            ...
                            <div class="form-group">
                                <label for="rango" class="col-form-label">Rango:</label>
                                <input type="text" class="form-control" id="rango">
                            </div>                
                            <div class="form-group">
                                <label for="tipo_trabajador" class="col-form-label">Tipo de Trabajador:</label>
                                <input type="number" class="form-control" id="tipo_trabajador">
                            </div>            
                        </div>
